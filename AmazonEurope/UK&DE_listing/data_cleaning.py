...
def constract_buybox_info(buybox_frame):
    ...
    # Seller 信息提取
    buybox_frame['Seller'] = buybox_frame['Buybox'].str.split('&').str[0].str.strip()
    # Delivery 信息提取
    buybox_frame['Delivery'] = buybox_frame['Buybox'].str.split('&').str[-1].str.strip()
...
def main():
    ...
    result_frame.to_excel(
        r'C:\Users\Administrator\data\运营\09222020\result\Sam_Buybox_Offer_Result.xls',
        sheet_name='Buybox and Offer Compare')

    color_excel(r'C:\Users\Administrator\data\运营\09222020\result\Sam_Buybox_Offer_Result.xls')
